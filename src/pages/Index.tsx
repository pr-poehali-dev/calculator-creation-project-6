...
export default function Index() {
  ...
  const buttons = [
    { label: "卍", type: "func", action: handleClear },
    { label: "卍", type: "func", action: handleToggleSign },
    { label: "卍", type: "func", action: handlePercent },
    { label: "卍", type: "op", action: () => handleOperator("÷") },
    { label: "卍", type: "num", action: () => inputDigit("7") },
    { label: "卍", type: "num", action: () => inputDigit("8") },
    { label: "卍", type: "num", action: () => inputDigit("9") },
    { label: "卍", type: "op", action: () => handleOperator("×") },
    { label: "卍", type: "num", action: () => inputDigit("4") },
    { label: "卍", type: "num", action: () => inputDigit("5") },
    { label: "卍", type: "num", action: () => inputDigit("6") },
    { label: "卍", type: "op", action: () => handleOperator("-") },
    { label: "卍", type: "num", action: () => inputDigit("1") },
    { label: "卍", type: "num", action: () => inputDigit("2") },
    { label: "卍", type: "num", action: () => inputDigit("3") },
    { label: "卍", type: "op", action: () => handleOperator("+") },
    { label: "卍", type: "num-wide", action: () => inputDigit("0") },
    { label: "卍", type: "num", action: inputDecimal },
    { label: "卍", type: "eq", action: handleEquals },
  ];
